    ...
    return (
        <div>
            <p className='text-lg'><span
                className='bg-green-500 text-white px-2 py-1 rounded-md font-mono'>Active</span></p>
            <p className='text-lg'>Update picture</p>
            <div className=' w-56 mx-auto'>
                <img className='h-56 w-56  shadow' style={{objectFit: 'cover', objectPosition: '50% 0%'}}
                     src={user?.profile_img ? `${user?.profile_img}` : '/images/default-avatar.png'}
                     alt="profile-image"/>
            </div>
