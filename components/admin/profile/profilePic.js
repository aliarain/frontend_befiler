...
const ProfilePic = ({ user, setRefreshData }) => {
    ...
    // form submission for picture update
    ...
    return (
        <div>
            ...
            <div className=' w-56 mx-auto'>
                <img className='h-56 w-56  shadow' style={{ objectFit: 'cover', objectPosition: '50% 0%' }} src={user?.profile_img ? profileImg ? profileImg : `${user?.profile_img}` : '/images/default-avatar.png'} alt="profile-image" />
            </div>
