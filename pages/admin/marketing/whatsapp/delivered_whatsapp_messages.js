...
const DeliveredWhatsappMessages = () => {
    ...
    const [allMails, gtAllMails] = useFetch(fetchAllWhatsappMessage, {status: 'success'});
    const columns = [
        {
            dataField: 'content',
    ...
    return (
        <div>
            <PageTitle title="Delivered Whatsapp Messages"/>
...
DeliveredWhatsappMessages.layout = AdminLayout;
export default DeliveredWhatsappMessages;
