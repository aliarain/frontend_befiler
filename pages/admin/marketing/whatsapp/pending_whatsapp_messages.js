...
const PendingWhatsappMessages = () => {
    ...
    const [allMails, gtAllMails] = useFetch(fetchAllWhatsappMessage, {status: 'pending'});
    const columns = [
        {
            dataField: 'content',
    ...
    return (
        <div>
            <PageTitle title="Pending Whatsapp Messages"/>
...
PendingWhatsappMessages.layout = AdminLayout;
