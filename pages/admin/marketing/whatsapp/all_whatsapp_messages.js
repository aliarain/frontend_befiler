...
const AllWhatsappMessages = () => {
    ...
    const [allMails, gtAllMails] = useFetch(fetchAllWhatsappMessage,);
    const columns = [
        {
            dataField: 'content',
    ...
    return (
        <div>
            <PageTitle title="All Whatsapp Messages"/>
...
AllWhatsappMessages.layout = AdminLayout;
export default AllWhatsappMessages;
