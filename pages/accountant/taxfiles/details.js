...
import {fetchTaxFileDetails, getAllAccountant, getSiteSettingInformationAPI} from '../../../helpers/backend_helper';
...
const TaxFileDetails = () => {
    ...
    const handlebackbtn = () => {
        router.push('/accountant/taxfiles/')
    }
            ...
            <section className="bg-gray-200 pt-12 min-h-screen">
                ...
                <div className='px-4'>
                    ...
                    <div className='md:grid md:grid-cols-2 gap-4'>
                        ...
                        {/* right side data */}
                        <TaxDataCard taxFileData={taxFileData} accountantData={accountantData} />
                    </div>
...
TaxFileDetails.layout = AccountantLayout
