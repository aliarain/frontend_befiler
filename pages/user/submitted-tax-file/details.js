...
import {fetchTaxFileDetails, getSiteSettingInformationAPI} from '../../../helpers/backend_helper';
            ...
            <section className="bg-gray-200 pt-12 min-h-screen">
                ...
                <div className='px-4'>
                    ...
                    <div className='md:grid md:grid-cols-2 gap-4'>
                        ...
                        {/* right side data */}
                        <TaxDataCard taxFileData={taxFileData} />
                    </div>
...
TaxFileDetails.layout = UserLayout
